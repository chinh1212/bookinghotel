    ...
    return (
        <div >
            ...
            <div className="slide3">
                ...
                <div className="slide1 lg:h-[800px] md:h-[600px]">
                    <div className="text-white text-7xl ">
                        <h1 > Welcome to CThotel</h1>
                        <p><span className="gachchu font-light">Hotel & Resorts</span></p>
                    </div>
                </div>
                <div className="absolute bottom-32 lg:left-96 md:left-2 bg-slate-300 lg:p-4 rounded-lg">
                    <SearchHome />
                </div>
            </div>
